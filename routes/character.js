...
// router.get("/:char_id", ensureCorrectUserOrAdmin, async function(req, res, next) {
//     try {
...
//  * Authorization required: Admin or same-user-as username
//  */
// router.delete("/:char_id", ensureCorrectUserOrAdmin, async function(req, res, next) {
//     try {
...
// router.post('/:char_id/spell_cards/:idx', ensureCorrectUserOrAdmin, async function(req, res, next){
//     try {
...
//  * Authorization required: Admin or same-user-as username
//  */
// router.delete("/:char_id/spell_cards/:idx", ensureCorrectUserOrAdmin, async function(req, res, next) {
//     try {
//         const spellIdx = req.params.idx;
